...
if(!s.includes(old)) throw new Error('route pattern not found');
s=s.replace(old,neu);
s=s.replace("web_app:{url:APP}","web_app:{url:APP+'/?v=20260912-1306'}");
fs.writeFileSync(p,s);
console.log('Maison Aurea route/cache patch applied');
